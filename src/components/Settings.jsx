...
const Settings = ({settings, setSettings, pomodoro, shortbreak, longbreak, setPomodoro, setLongbreak, setShortbreak, activeMode, setClicked, setFont, setColor}) => {
  const [color, setLocalColor] = useState('red');
  const [font, setLocalFont] = useState('kum'); 
  ...
  return (
    <div className={`flex justify-center absolute z-50 left-0 right-0 top-30 lg:top-45 ${settings ? 'block' : 'hidden'}`}>
        <div className='bg-dirtywhite min-w-[327px] lg:min-w-[540px] pt-[34px] rounded-4xl relative'>
            ...
            <h4 className='pt-[24px] pb-[22px] text-[13px] text-darkblue font-bold tracking-[5px] text-center lg:text-start px-[40px]'>TIME (MINUTES)</h4>
            <div className='flex flex-col lg:flex-row px-[40px] justify-between pb-[24px] gap-2 lg:gap-0'>
                <div className='relative flex lg:block items-center lg:items-start justify-between lg:justify-normal'>
                    ...
                    <div className='flex flex-col gap-[6px] bg-gray absolute lg:top-[37px] right-[15px] top-[14px]'>
            ...
            <div className='px-[40px] flex flex-col lg:flex-row items-center lg:items-start pt-[12px] lg:pt-[24px] justify-between pb-[24px]'>
                <p className='text-[13px] text-darkblue font-bold tracking-[5px] text-start pt-3 pb-5 lg:pb-0'>FONT</p>
            ...
            <hr className='text-gray max-w-[535px] mx-[40px]'/>
            <div className='flex flex-col lg:flex-row  items-center pt-[12px] justify-between px-[40px] lg:pt-[26px] pb-[50px]'>
            ...
            <button onClick={handleApply} className='bg-red text-white font-semibold px-[47px] pt-[18px] pb-[18px] absolute -bottom-7 left-[93px] lg:left-[200px] rounded-full cursor-pointer'>Apply</button>
        </div>
    </div>
